...
class ResizerView(ListView):
    # change the model here to the model you want to display
    template_name = "mainapp/resize.html"
    ...
    def get(self, request, *args, **kwargs):
        ...
        # save and get from in a dir that has the user ip as part of the path
        resized_dir = os.path.join("resized", "freetrial", client_ip.replace(":", "_").replace(".", "_"))
    ...
    def post(self, request, *args, **kwargs):
        ...
        saved_paths = self._save_uploaded_images(files, client_ip.replace(":", "_").replace(".", "_"))
    ...
    def _save_uploaded_images(self, files, client_ip):
        """
        ...
        media_subdir = os.path.join("uploads", "freetrial", client_ip)
        media_resized_subdir = os.path.join("resized", "freetrial", client_ip)
